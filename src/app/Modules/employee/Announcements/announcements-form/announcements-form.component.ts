...
export class AnnouncementsFormComponent implements OnInit {
  ...
  constructor(public TMS: TMS, public router: Router, public dialogRef: MatDialogRef<AnnouncementsDashComponent>,
  ...
  public getData() {
    this.TMS.GetAnnouncementsByBuildingID(56)
      .subscribe({
        next: data => {
          debugger
  ...
  public InsertAnnouncement() {
    ...
    if (this.short == undefined || this.short == "" || this.description == undefined || this.description == "" || this.startDate == undefined || this.startDate == "" || this.endDate == undefined || this.endDate == "" || this.venue == undefined || this.venue == "") {
      ...
      this.TMS.InsertAnnouncements(eb)
        .subscribe({
          next: data => {
            debugger
  ...
  public InsertNotification() {
    ...
    this.TMS.InsertNotification(entity)
      .subscribe({
        next: data => {
          debugger
          if (data != 0) {
  ...
  public UpdateAnnouncement() {
    ...
    this.TMS.UpdateAnnouncements(eb)
      .subscribe({
        next: data => {
          debugger
          this.loader = false;
