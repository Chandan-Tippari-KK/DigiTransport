...
export class TMS {
  public host = 'https://103.12.1.103/DigiTransportAPI/';
  ...
  public GetLoanConfiguration() {
    return this.http.get<any[]>(this.host + '/Master/GetLoanConfiguration');
  }
  ...
  public GetCancelledStaffLeaves(ID: any, TypeID: any, Sdate: any, Edate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetCancelledStaffLeaves?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetLoanMaster() {
    return this.http.get<any[]>(this.host + '/Master/GetLoanMaster');
  }
  ...
  public InsertEmployeeLoansBulkUpload(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertEmployeeLoansBulkUpload';
    return this.http.post(this.url, data);
  }
  ...
  public GetShiftMaster() {
    return this.http.get<any[]>(this.host + '/Master/GetShiftMaster');
  }

  public GetOTRates() {
    return this.http.get<any[]>(this.host + '/Master/GetOTRates');
  }
  public GetProjectFolders() {
    return this.http.get<any[]>(this.host + '/Master/GetProjectFolders');
  }
  ...
  public GetSupervisor() {
    return this.http.get<any[]>(this.host + '/MobileUser/GetSupervisor?ID=0');
  }

  public GetExpensesListweb() {
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/GetExpensesListweb?UserID=227&TypeID=2&SDate=01-01-2020&EDate=01-01-2025'
    );
  }
  ...
  public Get_Employees_For_Payroll(startdate: any, enddate: any) {
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/Get_Employees_For_Payroll?startdate=' +
      startdate +
      '&enddate=' +
      enddate
    );
  ...
  public GetApprovedStaffLeavesByHR(
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetApprovedStaffLeavesByHR?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetPendingStaffLeavesByHR(
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetPendingStaffLeavesByHR?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetRejectedStaffLeavesByHR(
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetRejectedStaffLeavesByHR?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetLocatorRequests(UserID: any, TypeID: any, Sdate: any, Edate: any) {
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/GetLocatorRequests?UserID=' +
      UserID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetAttendanceByManagerID(UserID: any, Sdate: any, Edate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetAttendanceByManagerID?userID=' +
      UserID +
      '&sdate=' +
      Sdate +
      '&edate=' +
  ...
  public GetAnnouncementsByBuildingID(BuildingID: any) {
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/GetAnnouncementsByBuildingID?BuildingID=' +
      BuildingID
    );
  }
  ...
  public insertexcel(files: any, payrollid: any, filename: any) {
    return this.http.post(
      this.host +
      '/Master/ProjectAttachmentsbyuseridwithname?userid=' +
      payrollid +
      '&filename=' +
      filename,
      files
  ...
  public Genearatezipwithpassword(files: any, payrollid: any) {
    return this.http.post(
      this.host + '/Master/Genearatezipwithpassword?userid=' + payrollid,
      files
    );
  }
  ...
  public GetCompanyDetails() {
    return this.http.get<any[]>(this.host + '/Building/GetCompanyDetails');
  }
  ...
  public GetHolidays() {
    return this.http.get<any[]>(this.host + '/Building/GetHolidays');
  }

  public GetPolicies() {
    return this.http.get<any[]>(this.host + '/Building/GetPolicies');
  }
  ...
  public GetMyDetailsForLogin(username: any, Password: any, roletype: any) {
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetMyDetailsForLogin?EmailID=' +
      username +
      '&Password=' +
      Password +
      '&roleType=' +
  ...
  public GetStaffLeaveCountForDashboard(
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetStaffLeaveCountForDashboard?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetStaffOTCountForDashboard(
    ID: any,
    type: any,
    StartTime: any,
    EndTime: any
    ...
    return this.http.get<any[]>(
      this.host +
      '/Master/GetStaffOTCountForDashboard?ID=' +
      ID +
      '&type=' +
      type +
      '&StartTime=' +
  ...
  public GetMyDetails() {
    ...
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetMyDetails?username=' +
      'Amaze2022' +
      '&password=' +
      'P@ssw0rd@2022'
    );
  ...
  public GetMyDetailsBycompany(url: any) {
    debugger;
    return this.http.get<any[]>(url + '/Announcement/GetMyDetails');
  }
  ...
  public GetTransportationRequests() {
    return this.http.get<any[]>(
      this.host +
      '/TransportationRequest/GetTransportationRequest?UserID=227&TypeID=2&SDate=01-01-2020&EDate=01-01-2029'
    );
  }
  ...
  public GetCountryType() {
    return this.http.get<any[]>(this.host + '/Building/GetCountryType');
  }
  public GetGrivenceMaster() {
    return this.http.get<any[]>(this.host + '/Master/GetGrivenceMaster');
  }
  ...
  public GetCityType() {
    return this.http.get<any[]>(this.host + '/Building/GetCityType?StateID=4');
  }
  ...
  public GetPositionDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetPositionDetails');
  }

  public GetMyAddressDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetMyAddressDetails');
  }

  public GetDependentDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetDependentDetails');
  }

  public GetNomination() {
    return this.http.get<any[]>(this.host + '/Master/GetNomination');
  }

  public GetEmploymentDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetEmploymentDetails');
  }

  public GetEducationDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetEducationDetails');
  }

  public GetBankDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetBankDetails');
  }

  public GetID_Details() {
    return this.http.get<any[]>(this.host + '/Master/GetID_Details');
  }

  public GetVisaDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetVisaDetails');
  }

  public GetSalaryDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetSalaryDetails');
  }
  ...
  public DeleteCityType(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteCityType?ID=' + ID);
  }
  ...
  public DeleteStateType(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteStateType?ID=' + ID);
  }
  ...
  public DeleteHolidays(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteHolidays?ID=' + ID);
  }
  ...
  public GetAttendance() {
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/GetAttendance?UserID=1&SDate=2022-10-01&EDate=2029-10-31'
    );
  }
  ...
  public GetAttendanceBydate(sdate: any, edate: any) {
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/GetAttendance?UserID=1&SDate=' +
      sdate +
      '&EDate=' +
      edate
    );
  ...
  public GetEmployeeAttedanceReport(sdate: any, edate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetEmployeeAttedanceReport?UserID=1&SDate=' +
      sdate +
      '&EDate=' +
      edate
    );
  ...
  public GetAttendanceByEmployeeID(UserID: any, SDate: any, EDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/GetAttendanceByEmployeeID?UserID=' +
      UserID +
      '&SDate=' +
      SDate +
      '&EDate=' +
  ...
  public GetAttendanceByEmployeeIDforpunchin(
    ...
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/GetAttendanceByEmployeeIDforpunchin?UserID=' +
      UserID +
      '&SDate=' +
      SDate +
      '&EDate=' +
  ...
  public GetTimeSheetDetailsforwebByEmployeeID(
    ...
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetTimeSheetDetailsforwebByEmployeeID?UserID=' +
      UserID +
      '&SDate=' +
      SDate +
      '&EDate=' +
  ...
  public GetHolidaybit(Date: any, StaffID: any) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetHolidaybit?Date=' +
      Date +
      '&StaffID=' +
      StaffID
    );
  ...
  public RejectTravelRequest(id: any, Rejected: any) {
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/RejectTravelRequest?ID=' +
      id +
      '&RejectReason=' +
      Rejected
    );
  ...
  public DeleteOTRates(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteOTRates?ID=' + ID);
  }
  ...
  public CancelWorkplaceRequest(ID: any, WorkStationID: any) {
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/CancelWorkplaceRequest?ID=' +
      ID +
      '&WorkStationID=' +
      WorkStationID
    );
  ...
  public GetStaffShiftDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetStaffShiftDetails');
  }
  ...
  public GetNotificationTokenByStaffID(StaffID: any) {
    return this.http.get<any[]>(
      'https://asticom.digiofficeapp.com/AsticomMainUATTestAll' +
      '/MobileUser/GetNotificationTokenByStaffID?StaffID=' +
      StaffID
    );
  }
  deviceid: any;
  public pushnotificationtomobile(StaffID: any, body: any, title: any) {
    debugger;
    this.GetNotificationTokenByStaffID(StaffID).subscribe({
      next: (data) => {
        debugger;
        let temp: any = data;
        if (temp.length != 0) {
  ...
  public GetStaffLeavesForPayrollByDate(
    startdate: any,
    enddate: any,
    StaffID: any
  ) {
    ...
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetStaffLeavesForPayrollByDate?startdate=' +
      startdate +
      '&enddate=' +
      enddate +
      '&StaffID=' +
  ...
  public Get_Salary_Splits(
    ...
    return this.http.get<any[]>(
      this.host +
      '/Announcement/Get_Salary_Splits?EmployeeID=' +
      EmployeeID +
      '&LopdaysCount=' +
      LopdaysCount +
      '&startdate=' +
  ...
  public Get_Salary_Splitsfor15days(
    EmployeeID: any,
    startdate: any,
    enddate: any
  ) {
    ...
    return this.http.get<any[]>(
      this.host +
      '/Announcement/Get_Salary_Splitsfor15days?EmployeeID=' +
      EmployeeID +
      '&startdate=' +
      startdate +
      '&enddate=' +
  ...
  public GetEmployeeSalary() {
    debugger;
    return this.http.get<any[]>(this.host + '/Announcement/GetEmployeeSalary');
  }
  ...
  public GetEmployeeBenfits() {
    return this.http.get<any[]>(this.host + '/Announcement/GetEmployeeBenfits');
  }
  ...
  public ProjectAttachmentsbyuseridforovertime(files: any, empid: any) {
    ...
    this.url =
      this.host +
      '/Master/ProjectAttachmentsbyuseridforovertime?empid=' +
      empid;
    return this.http.post<any[]>(this.url, formdata);
  }
  ...
  public GetPayrollFilesDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetPayrollFilesDetails');
  }
  ...
  public GetEmployeeLoans() {
    return this.http.get<any[]>(this.host + '/Announcement/GetEmployeeLoans');
  }
  ...
  public DeleteFloorType(ID: any) {
    debugger;
    return this.http.get<any[]>(this.host + '/Building/deletefloor?ID=' + ID);
  }
  ...
  public GetHelpdeskrequest() {
    return this.http.get<any[]>(this.host + '/Announcement/GetHelpdeskrequest');
  }
  ...
  public GetCompanyConfiguration() {
    return this.http.get<any[]>(this.host + '/Master/GetCompanyConfiguration');
  }
  ...
  public GetLeaveConfiguration() {
    return this.http.get<any[]>(this.host + '/Master/GetLeaveConfiguration');
  }
  ...
  public GetBarangayMaster() {
    return this.http.get<any[]>(this.host + '/Master/GetBarangayMaster');
  }

  public GetLeaveTypeforconfig() {
    return this.http.get<any[]>(this.host + '/Master/GetLeaveTypeforconfig');
  }

  public GetOtConfiguration() {
    return this.http.get<any[]>(this.host + '/Master/GetOtConfiguration');
  }
  ...
  public GetLeaveBalanceDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetLeaveBalanceDetails');
  }
  ...
  public GetCompanyAssets() {
    return this.http.get<any[]>(this.host + '/Master/GetCompanyAssets');
  }
  ...
  public DeleteFleet(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteFleet?ID=' + ID);
  }
  public DeleteRouteMaster(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteRouteMaster?ID=' + ID
    );
  }

  public DeleteClientLogin(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteClientLogin?ID=' + ID
    );
  }
  public DeleteAreaMaster(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteAreaMaster?ID=' + ID
    );
  }
  ...
  public GetAllStaffCounts() {
    debugger;
    return this.http.get<any[]>(this.host + '/Announcement/GetAllStaffCounts');
  }

  public GetServiceAward() {
    debugger;
    return this.http.get<any[]>(this.host + '/Announcement/GetServiceAward');
  }
  ...
  public GetOnBoardingChecklist() {
    return this.http.get<any[]>(this.host + '/Master/GetOnBoardingChecklist');
  }
  ...
  public AcceptEmployeeResignation(ID: any, TypeID: any) {
    return this.http.get<any[]>(
      this.host +
      '/Master/AcceptEmployeeResignation?ID=' +
      ID +
      '&TypeID=' +
      TypeID
    );
  ...
  public GetRetirementList() {
    debugger;
    return this.http.get<any[]>(this.host + '/Announcement/GetRetirementList');
  }
  ...
  public GetAssignedAssets() {
    debugger;
    return this.http.get<any[]>(this.host + '/Announcement/GetAssignedAssets');
  }
  ...
  public GetEmployeeTask() {
    debugger;
    return this.http.get<any[]>(this.host + '/Announcement/GetEmployeeTask');
  }
  ...
  public GetcostAllocation() {
    debugger;
    return this.http.get<any[]>(this.host + '/Announcement/GetcostAllocation');
  }
  ...
  public GetSuccessionPlanning() {
    debugger;
    return this.http.get<any[]>(this.host + '/Master/GetSuccessionPlanning');
  }
  ...
  public GetSupportTickets() {
    return this.http.get<any[]>(this.host1 + '/Master/GetSupportTickets');
  }
  ...
  public GetATDRequests() {
    debugger;
    return this.http.get<any[]>(this.host + '/Master/GetATDRequests');
  }
  ...
  public GetCompanyIDForSuperAdmin(CompanyID: any, url: any) {
    ...
    let APIURL =
      url + '/MobileUser/GetCompanyIDForSuperAdmin?CompanyID=' + CompanyID;
    //let APIURL = this.basehost + "/MobileUser/GetCompanyIDfortest?CompanyID=" + CompanyID;
    return this.http.get<any[]>(APIURL);
  }
  ...
  public DeleteRoleType(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteRoleType?ID=' + ID);
  }
  ...
  public DeleteLevelType(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteLevelType?ID=' + ID);
  }
  ...
  public GetExceptionLogs() {
    return this.http.get<any[]>(this.host + '/Master/GetExceptionLogs');
  }

  public GetAttendanceCorrection(UserID: any, SDate: any, EDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetAttendanceCorrection?UserID=' +
      UserID +
      '&SDate=' +
      SDate +
      '&EDate=' +
  ...
  public GetAttendanceCorrection1() {
    return this.http.get<any[]>(this.host + '/Master/GetAttendanceCorrection');
  }

  public GetStaffOverTimeDetailsAdjustments(
    StaffID: any,
    startdate: any,
    enddate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetStaffOverTimeDetailsAdjustments?staffid=' +
      StaffID +
      '&startdate=' +
      startdate +
      '&enddate=' +
  ...
  public GetApprovedStaffLeavesByStaffID(
    ID: any,
    TypeID: any,
    Sdate: any,
    Edate: any
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetApprovedStaffLeavesByStaffID?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetApprovedAttendanceCorrectionByStaffID(
    UserID: any,
    Sdate: any,
    Edate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetApprovedAttendanceCorrectionByStaffID?ID=' +
      '&UserID=' +
      UserID +
      '&Sdate=' +
      Sdate +
  ...
  public GetPendingStaffLeavesByStaffID(
    ID: any,
    TypeID: any,
    Sdate: any,
    Edate: any
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetPendingStaffLeavesByStaffID?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetPendingAttendanceCorrectionByStaffID(
    UserID: any,
    Sdate: any,
    Edate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetPendingAttendanceCorrectionByStaffID?ID=' +
      '&UserID=' +
      UserID +
      '&Sdate=' +
      Sdate +
  ...
  public GetRejectedStaffLeavesByStaffID(
    ID: any,
    TypeID: any,
    Sdate: any,
    Edate: any
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetRejectedStaffLeavesByStaffID?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetRejectedAttendanceCorrectionByStaffID(
    UserID: any,
    Sdate: any,
    Edate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetRejectedAttendanceCorrectionByStaffID?ID=' +
      '&UserID=' +
      UserID +
      '&Sdate=' +
      Sdate +
  ...
  public GetApprovedStaffLeavesBySupervisor(
    ID: any,
    TypeID: any,
    Sdate: any,
    Edate: any
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetApprovedStaffLeavesBySupervisor?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetApprovedAttendanceCorrectionBySupervisor(
    UserID: any,
    Sdate: any,
    Edate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetApprovedAttendanceCorrectionBySupervisor?ID=' +
      '&UserID=' +
      UserID +
      '&Sdate=' +
      Sdate +
  ...
  public GetPendingStaffLeavesBySupervisor(
    ID: any,
    TypeID: any,
    Sdate: any,
    Edate: any
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetPendingStaffLeavesBySupervisor?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetPendingAttendanceCorrectionBySupervisor(
    UserID: any,
    Sdate: any,
    Edate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetPendingAttendanceCorrectionBySupervisor?ID=' +
      '&UserID=' +
      UserID +
      '&Sdate=' +
      Sdate +
  ...
  public GetRejectedStaffLeavesBySupervisor(
    ID: any,
    TypeID: any,
    Sdate: any,
    Edate: any
    ...
    return this.http.get<any[]>(
      this.host +
      '/Building/GetRejectedStaffLeavesBySupervisor?ID=' +
      ID +
      '&TypeID=' +
      TypeID +
      '&Sdate=' +
  ...
  public GetRejectedAttendanceCorrectionBySupervisor(
    UserID: any,
    Sdate: any,
    Edate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetRejectedAttendanceCorrectionBySupervisor?ID=' +
      '&UserID=' +
      UserID +
      '&Sdate=' +
      Sdate +
  ...
  public DeleteTimesheet() {
    return this.http.get<any[]>(this.host + '/Master/DeleteTimesheet?ID=');
  }
  ...
  public GetStaffDetailsByEmpIDandSSS(EmpID: any, SssNO: any) {
    ...
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetStaffDetailsByEmpIDandSSS?EmpID=' +
      EmpID +
      '&SssNO=' +
      SssNO
    );
  ...
  public GetLogActivityByDate(StaffID: any, startdate: any, enddate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetLogActivityByDate?ID=' +
      StaffID +
      '&startdate=' +
      startdate +
      '&enddate=' +
  ...
  public GetTimeSheetTableAttachment() {
    return this.http.get<any[]>(
      this.host + '/Master/GetTimeSheetTableAttachment'
    );
  }

  public GetLocatorTableAttachment() {
    return this.http.get<any[]>(
      this.host + '/Master/GetLocatorTableAttachment'
    );
  }

  public GetEmployeeLoansAttachment() {
    return this.http.get<any[]>(
      this.host + '/Master/GetEmployeeLoansAttachment'
    );
  }

  public GetGrivenceRequestsAttachment() {
    return this.http.get<any[]>(
      this.host + '/Master/GetGrivenceRequestsAttachment'
    );
  }

  public GetStaffResignationAttachment() {
    return this.http.get<any[]>(
      this.host + '/Master/GetStaffResignationAttachment'
    );
  }

  public GetStaffOverTimeDetailsAttachment() {
    return this.http.get<any[]>(
      this.host + '/Master/GetStaffOverTimeDetailsAttachment'
    );
  }
  ...
  public GetAllStaffNewforpersonaldata(ID: any, StartDate: any, EndDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetAllStaffNewforpersonaldata?ID=' +
      ID +
      '&StartDate=' +
      StartDate +
      '&EndDate=' +
  ...
  public GetStaffOverTimeDetailsForPayroll(
    StaffID: any,
    StartDate: any,
    EndDate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetStaffOverTimeDetailsForPayroll?StaffID=' +
      StaffID +
      '&StartDate=' +
      StartDate +
      '&EndDate=' +
  ...
  public GetPayslipByMonthandStaffID(
    Year: any,
    Month: any,
    Payperiod: any,
    filename: any
    ...
    return this.http.get<any>(
      this.host +
      '/Master/GetPayslipByMonthandStaffID?Year=' +
      Year +
      '&Month=' +
      Month +
      '&Payperiod=' +
  ...
  public GetStaffLicenseDetailsbycompany(companyid: any) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetStaffLicenseDetailsbycompany?companyid=' +
      companyid
    );
  }
  ...
  public GetStaffOverTimeDetailsByEmployeID(
    StaffID: any,
    SDate: any,
    EDate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetStaffOverTimeDetailsByEmployeID?StaffID=' +
      StaffID +
      '&SDate=' +
      SDate +
      '&EDate=' +
  ...
  public GetStaffOverTimeDetailsByManagerID(
    StaffID: any,
    SDate: any,
    EDate: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetStaffOverTimeDetailsByManagerID?StaffID=' +
      StaffID +
      '&SDate=' +
      SDate +
      '&EDate=' +
  ...
  public GetStaffOverTimeDetailsByDate(SDate: any, EDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetStaffOverTimeDetailsByDate?SDate=' +
      SDate +
      '&EDate=' +
      EDate
    );
  ...
  public GetStaffOverTimeDetailsByDateforreport(SDate: any, EDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Announcement/GetStaffOverTimeDetailsByDateforreport?SDate=' +
      SDate +
      '&EDate=' +
      EDate
    );
  ...
  public GetStaffExitFormalityAttachment() {
    return this.http.get<any[]>(
      this.host + '/Master/GetStaffExitFormalityAttachment'
    );
  }
  ...
  public GetAttendanceByEmployeeIDforpunchin1daybefore(
    ...
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/GetAttendanceByEmployeeIDforpunchin1daybefore?UserID=' +
      UserID +
      '&SDate=' +
      SDate +
      '&EDate=' +
  ...
  public GetCurrentPhTime(UserID: any, SDate: any, EDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/MobileUser/GetCurrentPhTime?UserID=' +
      UserID +
      '&SDate=' +
      SDate +
      '&EDate=' +
  ...
  public GetGeneratedCoeDetailsByDate(SDate: any, EDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetGeneratedCoeDetailsByDate?StartDate=' +
      SDate +
      '&EndDate=' +
      EDate
    );
  ...
  public UpdateAcceptStatusSupportTickets(data: any) {
    debugger;
    this.url =
      'https://asticom.digiofficeapp.com/SupportAPI' +
      '/Master/UpdateAcceptStatusSupportTickets';
    return this.http.post(this.url, data);
  }
  public UpdateCloseStatusSupportTickets(data: any) {
    ...
    this.url =
      'https://asticom.digiofficeapp.com/SupportAPI' +
      '/Master/UpdateCloseStatusSupportTickets';
    return this.http.post(this.url, data);
  }
  ...
  public GetHRDashboard_HeadCountByGenderByEmployee(EmployeeID: any) {
    return this.http.get<any[]>(
      this.host +
      '/HR/GetHRDashboard_HeadCountByGenderByEmployee?EmployeeID=' +
      EmployeeID
    );
  }

  public GetHRDashboard_HeadCountByGenderByEmployeeByMonth(
    EmployeeID: any,
    Month: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/HR/GetHRDashboard_HeadCountByGenderByEmployeeByMonth?EmployeeID=' +
      EmployeeID +
      '&Month=' +
      Month
    );
  ...
  public GetHRDashboard_HeadCountByGenderByManager(ManagerID: any) {
    return this.http.get<any[]>(
      this.host +
      '/HR/GetHRDashboard_HeadCountByGenderByManager?ManagerID=' +
      ManagerID
    );
  }

  public GetHRDashboard_HeadCountByGenderByManagerByMonth(
    ManagerID: any,
    Month: any
  ) {
    return this.http.get<any[]>(
      this.host +
      '/HR/GetHRDashboard_HeadCountByGenderByManagerByMonth?ManagerID=' +
      ManagerID +
      '&Month=' +
      Month
    );
  ...
  public GetOnBoardingInitiation() {
    return this.http.get<any[]>(this.host + '/Master/GetOnBoardingInitiation');
  }
  ...
  public GetHRDashboard_HeadCount() {
    return this.http.get<any[]>(this.host + '/HR/GetHRDashboard_HeadCount');
  }
  public GetHRDashboard_HeadCountByGenderByMonth(Gender: any, Month: any) {
    return this.http.get<any[]>(
      this.host +
      '/HR/GetHRDashboard_HeadCountByGenderByMonth?Gender=' +
      Gender +
      '&Month=' +
      Month
    );
  ...
  public GetStaffDeatilsforLogin(RoleID: any, EmailID: any, Password: any) {
    return this.http.get<any[]>(
      this.host +
      '/Candidate/GetStaffDeatilsforLogin?RoleID=' +
      RoleID +
      '&EmailID=' +
      EmailID +
      '&Password=' +
  ...
  public GetStaff() {
    return this.http.get<any[]>(this.host + '/Candidate/GetStaff');
  }
  public GetJobGrade() {
    return this.http.get<any[]>(this.host + '/Candidate/GetJobGrade');
  }
  public GetJobTitle() {
    return this.http.get<any[]>(this.host + '/Candidate/GetJobTitle');
  }
  public GetCustomer() {
    return this.http.get<any[]>(this.host + '/Candidate/GetCustomer');
  }
  public GetRoleType() {
    return this.http.get<any[]>(this.host + '/Candidate/GetRoleType');
  }
  public GetDepartment() {
    return this.http.get<any[]>(this.host + '/Candidate/GetDepartment');
  }
  public GetTickets() {
    return this.http.get<any[]>(this.host + '/Candidate/GetTickets');
  }
  public GetClosedTickets() {
    return this.http.get<any[]>(this.host + '/Candidate/GetClosedTickets');
  }
  public GetCountry() {
    return this.http.get<any[]>(this.host + '/Candidate/GetCountry');
  }
  public GetState() {
    return this.http.get<any[]>(this.host + '/Candidate/GetState');
  }
  public GetAcceptedTickets() {
    return this.http.get<any[]>(this.host + '/Candidate/GetAcceptedTickets');
  }
  public GetRejectedTickets() {
    return this.http.get<any[]>(this.host + '/Candidate/GetRejectedTickets');
  }
  public GetFleet() {
    return this.http.get<any[]>(this.host + '/Master/GetFleet');
  }
  public GetRouteMaster() {
    return this.http.get<any[]>(this.host + '/Master/GetRouteMaster');
  }
  public GetAreaMaster() {
    return this.http.get<any[]>(this.host + '/Master/GetAreaMaster');
  }
  public GetClientLogin() {
    return this.http.get<any[]>(this.host + '/Master/GetClientLogin');
  }
  // public GetJobGrade() {
  //   return this.http.get<any[]>(
  //     this.host + "/Candidate/GetJobGrade");
  // }
  // public GetJobTitle() {
  //   return this.http.get<any[]>(
  //     this.host + "/Candidate/GetJobTitle");
  // }
  public GetCity() {
    return this.http.get<any[]>(this.host + '/Candidate/GetCity');
  }
  public GetTicketsForCustomer() {
    return this.http.get<any[]>(this.host + '/Candidate/GetTicketsForCustomer');
  }

  public InsertStaff(data: any) {
    debugger;
    this.url = this.host + '/Candidate/InsertStaff';
    return this.http.post(this.url, data);
  }
  public InsertFleet(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertFleet';
    return this.http.post(this.url, data);
  }
  public UpdateFleet(data: any) {
    debugger;
    this.url = this.host + '/Master/UpdateFleet';
    return this.http.post(this.url, data);
  }
  public UpdateClientLogin(data: any) {
    debugger;
    this.url = this.host + '/Master/UpdateClientLogin';
    return this.http.post(this.url, data);
  }
  public UpdateAreaMaster(data: any) {
    debugger;
    this.url = this.host + '/Master/UpdateAreaMaster';
    return this.http.post(this.url, data);
  }
  public UpdateRouteMaster(data: any) {
    debugger;
    this.url = this.host + '/Master/UpdateRouteMaster';
    return this.http.post(this.url, data);
  }
  public InsertTickets(data: any) {
    debugger;
    this.url = this.host + '/Candidate/InsertTickets';
    return this.http.post(this.url, data);
  }
  public InsertCustomer(data: any) {
    debugger;
    this.url = this.host + '/Candidate/InsertCustomer';
    return this.http.post(this.url, data);
  }
  public InsertCleintLogin(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertClientLogin';
    return this.http.post(this.url, data);
  }
  ...
  public ApproveDailyTrip(data: any) {
    debugger;
    this.url = this.host + '/Master/ApproveDailyTrip';
    return this.http.post(this.url, data);
  }

  public InsertRouteMaster(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertRouteMaster';
    return this.http.post(this.url, data);
  }
  public UpdateApproveTickets(data: any) {
    debugger;
    this.url = this.host + '/Candidate/UpdateApproveTickets';
    return this.http.post(this.url, data);
  }
  public UpdateRejectTickets(data: any) {
    debugger;
    this.url = this.host + '/Candidate/UpdateRejectTickets';
    return this.http.post(this.url, data);
  }
  public UpdateAssignTickets(data: any) {
    debugger;
    this.url = this.host + '/Candidate/UpdateAssignTickets';
    return this.http.post(this.url, data);
  }
  public UpdateClosedTickets(data: any) {
    debugger;
    this.url = this.host + '/Candidate/UpdateClosedTickets';
    return this.http.post(this.url, data);
  }
  public UpdateCustomer(data: any) {
    debugger;
    this.url = this.host + '/Candidate/UpdateCustomer';
    return this.http.post(this.url, data);
  }
  public UpdateStaff(data: any) {
    debugger;
    this.url = this.host + '/Candidate/UpdateStaff';
    return this.http.post(this.url, data);
  }
  ...
  public ProjectAttachments(files: any) {
    ...
    this.url = this.host + '/Master/ProjectAttachments';
    return this.http.post<any[]>(this.url, formdata);
  }
  public GetCustomerByID(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Candidate/GetCustomerByID?ID=' + ID
    );
  }
  public GetStaffGuardByID(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/GetStaffByID?ID=' + ID);
  }
  public GetStaffGuard() {
    return this.http.get<any[]>(this.host + '/Master/GetStaff');
  }
  public InsertStaffGuard(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertStaff';
    return this.http.post(this.url, data);
  }
  public UpdateStaffGuard(data: any) {
    debugger;
    this.url = this.host + '/Master/UpdateStaff';
    return this.http.post(this.url, data);
  }
  public DeleteStaffGuard(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteStaff?ID=' + ID);
  }
  public GetClientLoginByID(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetClientLoginByID?ID=' + ID
    );
  }
  public GetAreaMasterByID(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetAreaMasterById?ID=' + ID
    );
  }
  public GetRouteMasterByID(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetRouteMasterByID?ID=' + ID
    );
  }
  public GetFleetByID(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/GetFleetByID?ID=' + ID);
  }
  public GetStaffByID(ID: any) {
    return this.http.get<any[]>(this.host + '/Candidate/GetStaffByID?ID=' + ID);
  }

  public DeleteCustomer(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Candidate/DeleteCustomer?ID=' + ID
    );
  }
  public DeleteStaff(ID: any) {
    return this.http.get<any[]>(this.host + '/Candidate/DeleteStaff?ID=' + ID);
  }
  public GetAcceptedTicketsByDate(StartDate: any, EndDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Candidate/GetAcceptedTicketsByDate?StartDate=' +
      StartDate +
      '&EndDate=' +
      EndDate
    );
  }
  public GetRejectedTicketsByDate(StartDate: any, EndDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Candidate/GetRejectedTicketsByDate?StartDate=' +
      StartDate +
      '&EndDate=' +
      EndDate
    );
  ...
  public GetDailyTripsByDate(StartDate: any, EndDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetDailyTripsByDate?StartDate=' +
      StartDate +
      '&EndDate=' +
      EndDate
    );
  }
  public GetClosedTicketsByDate(StartDate: any, EndDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Candidate/GetClosedTicketsByDate?StartDate=' +
      StartDate +
      '&EndDate=' +
      EndDate
    );
  }
  public GetTicketsbydate(StartDate: any, EndDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Candidate/GetTicketsbydate?StartDate=' +
      StartDate +
      '&EndDate=' +
      EndDate
    );
  }
  public InsertNotificationsTMS(data: any) {
    debugger;
    this.url = this.host + '/Candidate/InsertNotificationsTMS';
    return this.http.post(this.url, data);
  }
  public GetNotificationsTMS() {
    return this.http.get<any[]>(this.host + '/Candidate/GetNotificationsTMS');
  }
  getLatlongbyaddreess(term: string) {
    return this.http.get<any[]>(
  ...
  getLocationJson(term: string) {
    ...
    return this.http
      .get(
        'https://maps.googleapis.com/maps/api/geocode/json?address=Someroad+64&key=AIzkeystuffjXDm6eU5mPP9Nczg'
      )
      .subscribe((json: any) => {
  ...
  public GetCompany() {
    return this.http.get<any[]>(this.host + '/Master/GetCompany');
  }

  public GetCompanyByID(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/GetCompanyByID?ID=' + ID);
  }

  public InsertCompany(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertCompany';
    return this.http.post(this.url, data);
  }

  public UpdateCompany(data: any) {
    debugger;
    this.url = this.host + '/Master/UpdateCompany';
    return this.http.post(this.url, data);
  }

  public DeleteCompany(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteCompany?ID=' + ID);
  }

  public GetDriver() {
    return this.http.get<any[]>(this.host + '/Master/GetDriver');
  }

  public GetDriverByID(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/GetDriverByID?ID=' + ID);
  }

  public InsertDriver(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertDriver';
    return this.http.post(this.url, data);
  }

  public UpdateDriver(data: any) {
    debugger;
    this.url = this.host + '/Master/UpdateDriver';
    return this.http.post(this.url, data);
  }

  public DeleteDriver(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteDriver?ID=' + ID);
  }

  public GetEmployee() {
    return this.http.get<any[]>(this.host + '/Master/GetEmployee');
  }

  public GetEmployeeByID(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/GetEmployeeByID?ID=' + ID);
  }

  public InsertEmployee(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertEmployee';
    return this.http.post(this.url, data);
  }

  public UpdateEmployee(data: any) {
    debugger;
    this.url = this.host + '/Master/UpdateEmployee';
    return this.http.post(this.url, data);
  }

  public UpdateEmployeeTrips(data: any) {
    debugger;
    this.url = this.host + '/Master/UpdateEmployeeTrips';
    return this.http.post(this.url, data);
  }

  public DeleteEmployee(ID: any) {
    return this.http.get<any[]>(this.host + '/Master/DeleteEmployee?ID=' + ID);
  }

  public DeleteEmployeeTrips(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteEmployeeTrips?ID=' + ID
    );
  }

  public InsertOfficeLoactions(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertOfficeLoactions';
    return this.http.post(this.url, data);
  }

  public Enable_Client(data: any) {
    debugger;
    this.url = this.host + '/Master/Enable_Client';
    return this.http.post(this.url, data);
  }

  public Enable_Driver(data: any) {
    debugger;
    this.url = this.host + '/Master/Enable_Driver';
    return this.http.post(this.url, data);
  }

  public GetOfficeLoactions() {
    return this.http.get<any[]>(this.host + '/Master/GetOfficeLoactions');
  }
  public GetOfficeLoactionsByClientID(data: any) {
    return this.http.get<any[]>(
      this.host + `/Master/GetOfficeLoactionsByClientID?ClientID=${data}`
    );
  }
  public DeleteOfficeLocation(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteOfficeLoactions?ID=' + ID
    );
  }

  public GetRouteNumber() {
    return this.http.get<any[]>(this.host + '/Master/GetRouteMaster');
  }

  public GetEmployeeRoaster() {
    return this.http.get<any[]>(this.host + '/Master/GetEmployeeRoaster');
  }

  public InsertEmployeeRoaster(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertEmployeeRoaster';
    return this.http.post(this.url, data);
  }

  public DeleteEmployeeRoaster(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/DeleteEmployeeRoaster?ID=' + ID
    );
  }

  public InsertEmployeeTrips(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertEmployeeTrips';
    return this.http.post(this.url, data);
  }

  public GetEmployeeTrips() {
    return this.http.get<any[]>(this.host + '/Master/GetEmployeeTrips');
  }
  public InsertDailyTrips(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertDailyTrips';
    return this.http.post(this.url, data);
  }
  public InsertDailyTripsDetails(data: any) {
    debugger;
    this.url = this.host + '/Master/InsertDailyTripsDetails';
    return this.http.post(this.url, data);
  }

  public GetEmployeeTripsByDate(StartDate: any, EndDate: any) {
    return this.http.get<any[]>(
      this.host +
      '/Master/GetEmployeeTripsByDate?StartDate=' +
      StartDate +
      '&EndDate=' +
      EndDate
    );
  ...
  public GetDailyTrips() {
    return this.http.get<any[]>(this.host + '/Master/GetDailyTrips');
  }

  public GetDailyTripsByID(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetDailyTripsByID?ID=' + ID
    );
  }

  public GetDailyTripsDetails() {
    return this.http.get<any[]>(this.host + '/Master/GetDailyTripsDetails');
  }

  public GetDailyTripsDetailsByID(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetDailyTripsDetailsByID?ID=' + ID
    );
  }

  public GetEmployeeTripsByID(ID: any) {
    return this.http.get<any[]>(
      this.host + '/Master/GetEmployeeTripsByID?ID=' + ID
    );
  }
}
